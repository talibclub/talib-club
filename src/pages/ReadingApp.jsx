      ...
      <div className={`app ${theme || "light"} reading-room-shell`} style={{
        ...
        {hudCollapsed && (
          <Draggable nodeRef={hudPillRef} handle=".hud-drag-handle" bounds="parent">
            <div ref={hudPillRef} style={{ position: "absolute", bottom: 24, left: 14, zIndex: 2100, display: "flex", alignItems: "center", gap: 6, background: "rgba(255, 255, 255, 0.9)", backdropFilter: "blur(16px)", WebkitBackdropFilter: "blur(16px)", border: "1px solid rgba(0,0,0,0.06)", borderRadius: 28, padding: "6px 10px 6px 8px", boxShadow: "0 12px 32px rgba(0,0,0,0.12), 0 2px 8px rgba(0,0,0,0.06)", touchAction: "none" }}>

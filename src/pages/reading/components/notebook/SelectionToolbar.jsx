...
import { Crop, ScanText, Type, ChevronsUp, ChevronsDown, FileStack, GitBranch, Trash2, Check } from 'lucide-react';
...
export default function SelectionToolbar({ left, top, kind, canEdit, onCrop, onOcr, onEdit, onBranch, onRecolor, onFront, onBack, onDuplicate, onDelete, onDone }) {

...
import { Crop, ScanText, Type, ChevronsUp, ChevronsDown, FileStack, GitBranch, Spline, Network, Trash2, Check } from 'lucide-react';
...
export default function SelectionToolbar({ left, top, kind, canEdit, onCrop, onOcr, onEdit, onBranch, onConnect, onAutoLayout, onRecolor, onFront, onBack, onDuplicate, onDelete, onDone }) {

...
import { Crop, ScanText, Type, ChevronsUp, ChevronsDown, FileStack, GitBranch, Spline, Trash2, Check } from 'lucide-react';
...
export default function SelectionToolbar({ left, top, kind, canEdit, onCrop, onOcr, onEdit, onBranch, onConnect, onRecolor, onFront, onBack, onDuplicate, onDelete, onDone }) {

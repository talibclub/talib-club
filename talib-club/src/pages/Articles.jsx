...
export default function Articles({ go }) {
  ...
  const [showAllBrowse, setShowAllBrowse] = useState(false) // ตัวเปิดปิดเพื่อขยายดูบทความเดี่ยวทั้งหมด
  ...
  // เงื่อนไขในการตัดหน้าแสดงผล: ถ้าไม่มีการเสิร์ช คัดกรอง หรือกดปุ่ม 'ดูทั้งหมด' จะแสดงหน้าสารบัญซีรีส์แบบคลีน
  const isDefaultView = !search && cat === "all" && type === "all" && !showAllBrowse
  const recentArticles = filtered.slice(0, 6) // จำกัดการแสดงบทความเดี่ยวในหน้าแรกไว้แค่ 6 บทความ
    ...
    <div>
      ...
      {isDefaultView ? (
        ...
        <div>
          ...
          {/* RECENT ARTICLES (แสดงเฉพาะบทความเดี่ยวมาใหม่ ไม่ยกมาทั้งหมด) */}
          <div>
        ...
        /* โหมดผลลัพธ์การค้นหา / ขยายดูทั้งหมด (Grid View) */
        <div>
